...
<div class="container-fluid mb-5">
    <div class="our-services mt-5">
      ...
      <div class="row text-center mt-5">
        ...
        <div class="service-list mt-3 py-5">
          <center><img src="{{ asset('storage\Images\web1.png') }}" style="height: 80px; width: 80px;" class="img-fluid"></center>
          <br>
  ...
  <div class="col-md-4">
    <div class="service-list mt-3 py-5">
                 <center><img src="{{ asset('storage\Images\android.png') }}" style="height: 80px; width: 80px;" class="img-fluid"></center>
              <br>
  ...
  <div class="col-md-4">
    <div class="service-list mt-3 py-5">
        <center><img src="{{ asset('storage\Images\game.png') }}" style="height: 80px; width: 80px;" class="img-fluid"></center>
        <br>
  ...
  <div class="col-md-4">
    <div class="service-list mt-3 py-5">
      <center><img src="{{ asset('storage\Images\graphic.png') }}" style="height: 80px; width: 80px;" class="img-fluid"></center>
      <br>
  ...
  <div class="col-md-4">
    <div class="service-list mt-3 py-5">
      <center><img src="{{ asset('storage\Images\hosting.png') }}" style="height: 80px; width: 80px;" class="img-fluid"></center>
      <br>
  ...
  <div class="col-md-4">
    <div class="service-list mt-3 py-5">
      <center><img src="{{ asset('storage\Images\windows.png') }}" style="height: 80px; width: 80px;" class="img-fluid"></center>
      <br>
