...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0"
        style="background-color: rgb(51, 36, 36)">
        @if (Route::has('login'))
            <div class=" fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ route('dashboard') }}" class="text-sm text-gray-700 underline"><b>Welcome To The
                            Blogged</b></a>
                @else
        ...
        <div class="max-w-7xl mx-auto sm:px-7 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <div style="background-size: cover; height:450px; padding-top: 50px; text-align: center;">
                    <h1 style="font-size:100px; color:white; margin:2px;">Get Blogged</h1>
                    <p style="font-size:30px; color: white;"><em>A Web By RaaZ Khanal</em></p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Blogged is a dynamic website to explore the world around you. It is developed in MVC
                                format using a LARAVEL framework that enables you to creat, post, view, modify your blog
                                and other many more activities. Laravel has wonderful, thorough documentation covering
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('register') }}"
                                    class="underline text-gray-900 dark:text-white">Sign Up</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Sign up/Registration has been made simpler and fully protected by the use of Php and
                                Laravel framework. Protecting Your data to the fullest. Laracasts offers thousands of
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="#"
                                    class="underline text-gray-900 dark:text-white">About US</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Presently, we have a small user and developer family working together and sharing the
                                things. To be one of our family member register soon!.
                                We are one the tardet of reaching 1M members soon!
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Upcoming
                                Projects</div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                We have been working on several projects on web development, appdevelopment, online
                                project handeling and many more. To know about our upcoming events and projects be in
                                touch with us. <a href="#" class="underline">Forge</a>, <a
