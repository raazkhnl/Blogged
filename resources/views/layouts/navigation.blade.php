<nav x-data="{ open: false }" style="background-color: rgb(116, 81, 81)" class="border-b sticky-top">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="   space-x-8 sticky-top sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('blog.creat')" :active="request()->routeIs('blog.creat')">
                        <b>{{ __('Creat a Blog') }}</b>
                    </x-nav-link>
            ...
            <x-slot name="content">
                ...
                <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-nav-link :href="route('logout')" onclick="event.preventDefault();
                                            this.closest('form').submit();" class="mt-3">
                            <b>{{ __('Log Out') }}</b> &nbsp;
                        </x-nav-link>
                    </form>
                </x-nav-link>
